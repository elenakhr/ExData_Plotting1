...
##### Plot 4 #####
# Create plot #1 and write it into the file
par(mfrow = c(2,2), mar = c(4, 4, 2, 1))
with(bb, plot(DateTime,Global_active_power,type ="l", ylab="Global Active Power", xlab=""))
with(bb, plot(DateTime,Voltage,type ="l", ylab="Voltage", xlab="datetime"))
...
with(bb, plot(DateTime,Global_reactive_power,type ="l", xlab="datetime"))
